import { IAuthStorage, Maybe, TokenString } from './types';
...
export declare const createAuthProvider: <Session>({ storageKey, onUpdateToken, onHydratation, storage, fetchFunction, getAccessToken, expirationThresholdMillisec, }: IAuthProviderConfig<Session>) => IAuthProvider<Session>;
