"""
Implementation for RoleMixin taken from flask-rbac. Other functionality from flask-rbac not needed.
https://github.com/shonenada/flask-rbac/blob/master/flask_rbac/model.py
"""
